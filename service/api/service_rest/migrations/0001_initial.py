# Generated by Django 4.0.3 on 2023-07-25 05:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.PositiveSmallIntegerField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Appointment',
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'In_progress'), (2, 'Canceled'), (3, 'Finished')], default=1)),
